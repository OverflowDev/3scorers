  ...
  return (
    <div>
        ...
        <aside className=" w-56 bg-scorers">
            ...
            <div className="my-12 flex flex-col items-center justify-center mt-6 space-y-2 tracking-wide">
                <Link 
                    to='/overview'
        ...
        <main className="-ml-48 flex flex-grow flex-col md:ml-0">
            ...
            <div className='bg-white w-full py-3 px-4 flex justify-between border-2'>
                <h1 className='text-2xl font-semibold text-scorers'>Admin</h1>
                <div className='flex flex-col items-center'>
                    <h1 className='text-medium text-lg'>{user?.firstName} {' '} {user?.lastName}</h1>
                    <h1 className='text-normal text-sm uppercase'>{user.role}</h1>
                </div>
            </div>
            {/* content  */}
            <div className="h-full m-4 px-8 ">
                ...
                <div className='mt-4 grid grid-cols-1'>
                    ...
                    <div className='h-16 bg-scorers flex items-center justify-between px-8'>
                        {/* Search  */}
                        <div className="relative mt-1">
                            ...
                            <input 
                                type="text" 
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none block w-64 pl-10 p-2.5 " 
                        ...
                        <div className=''>
                            <select
                                ...
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none block w-40 p-2.5"
                            >
                    ...
                    <div className='flex flex-col'>
                        <div className='bg-white w-full h-96 shadow-lg rounded-lg overflow-auto table-scroll'>
                            <div className="bg-white text-sm text-gray-500 font-bold px-5 py-2 shadow border-b">
                                User&apos;s Name
                            </div>
                            {/* Table  */}
                            {
                                            ...
                                            {users.map((usr) => ( usr.role === 'admin') && (
                                                <tr key={usr.id} className='relative transform scale-100 flex items-center justify-between py-1 px-8 cursor-default'>
                                                    ...
                                                    <td className="text-xs whitespace-no-wrap">
                                                        <button className='rounded-md bg-secondary hover:bg-scorers/10 text-black hover:text-white py-2 px-4 text-bold font-bold tracking-wider text-md focus:outline-none'>View Details</button>
                                                    </td>
                                                </tr>
                                            ))}
                                        </tbody>
